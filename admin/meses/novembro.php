...
<body>
  ...
  $selecionar = mysqli_query($conn, "SELECT * from documentos where mes like '11'");
...
<td>'.utf8_encode('<a target="_blank" href="../../usuario/planos_estagios/11/'.$sql['documento']).'">'.utf8_encode($sql["documento"]).'</a>'.'</td>
