...
<body>
  ...
  $selecionar = mysqli_query($conn, "SELECT * from documentos where mes like '08'");
...
<td>'.utf8_encode('<a target="_blank" href="../../usuario/planos_estagios/08/'.$sql['documento']).'">'.utf8_encode($sql["documento"]).'</a>'.'</td>
